...
int main(void) {
	puts("Hello World!!!");
	puts("NAME: THENMOZHI N");
	puts("REG. NO: 212223060291");/* prints Hello World!!! */
	return EXIT_SUCCESS;
}
...
<img width="1440" height="346" alt="image" src="https://github.com/user-attachments/assets/8950aa44-7143-4bda-bad7-cb5eb22e4ab2" />
